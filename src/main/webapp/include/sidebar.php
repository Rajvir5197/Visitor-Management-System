...
<li class="nav-item">
<a class="nav-link" href="manage-plant-view-all.php">
...
<a class="collapse-item" href="todays-visits-listing.php">Todays Visits Listing</a>
<a class="collapse-item" href="personcheck-out.php">Person Checkout</a>
<a class="collapse-item" href="#">Manage Check In</a>
</div>
</div>
</li>

<li class="nav-item">
<a class="nav-link" href="manage-contact-view-all.php">
...
<div class="collapse-inner" style="background-color:#3482ae;">
<a class="collapse-item" href="employee-master-view-all.php">Employee Master</a>
<a class="collapse-item" href="department-master-view-all.php">Department Master</a>
</div>
</div>
</li>
